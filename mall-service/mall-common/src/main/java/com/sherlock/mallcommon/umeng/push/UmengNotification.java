...
public abstract class UmengNotification {
	...
	public abstract boolean setPredefinedKeyValue(String key, Object value) throws MallException;
	...
	public void setProductionMode(Boolean prod) throws MallException {
    	setPredefinedKeyValue("production_mode", prod.toString());
    }

	///正式模式
    public void setProductionMode() throws MallException {
    	setProductionMode(true);
    }

    ///测试模式
    public void setTestMode() throws MallException {
    	setProductionMode(false);
    }

    ///发送消息描述，建议填写。
    public void setDescription(String description) throws MallException {
    	setPredefinedKeyValue("description", description);
    }

    ///定时发送时间，若不填写表示立即发送。格式: "YYYY-MM-DD hh:mm:ss"。
    public void setStartTime(String startTime) throws MallException {
    	setPredefinedKeyValue("start_time", startTime);
    }
    ///消息过期时间,格式: "YYYY-MM-DD hh:mm:ss"。
    public void setExpireTime(String expireTime) throws MallException {
    	setPredefinedKeyValue("expire_time", expireTime);
    }
    ///发送限速，每秒发送的最大条数。
    public void setMaxSendNum(Integer num) throws MallException {
